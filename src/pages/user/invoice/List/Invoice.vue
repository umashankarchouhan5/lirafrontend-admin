<template>
    <FormWrapper :is-loading="isLoading">
        <PageTitle title="Invoices" slot="title" :pdf="generatePdf" v-if="showPdf" />
        <PageTitle title="Invoices" slot="title"  v-else/>
        <div :class="$style.filter">
            ...
            <div :class="$style.filterItem">
                <InputText v-model="filtering.invoiceNumber" label="Invoice Number" />
            </div>
            <div :class="$style.filterItem">
        ...
        <DataTable :actions="true"
            ...
            <template slot="actionsLeft">
                ...
                <TableButton @click="() => generateInvoice()" >
                    <img src="../../../../assets/images/view_receipt.png" />
                    Generate Invoice
                </TableButton>
            </template>
...
<script>
    ...
    import { exportInvoicesExcel, fetchReceiptByInvoiceId, getInvoiceListByAdmin, getInvoiceStatus, searchCompanies, exportInvoices } from '../api'
    ...
    export default {
        ...
        computed: {
            ...
            invoiceList() {
                if(this.invoices.length > 0){
                    var list = this.invoices.map( ele => {
                        if(ele.Amount!==null) {
        ...
        methods: {
            generateInvoice(){
                window.open('/generateInvoice', '_blank')
            },
            generatePdf() {
                this.showLoader();
