<template>
    <FormWrapper :is-loading="isLoading">
        ...
        <PageTitle title="Complaint Register" slot="title"  :pdf="generatePdf" v-if="showPdf"/>
        <PageTitle title="Complaint Register" slot="title" v-else/>
...
<!-- Message popup -->
        ...
        <!-- complaint popup -->
        <Popup title="Complaint Summary" :value="complaintSummaryModal.visible" @close="() => complaintSummaryModal.visible = false">
            {{ complaintSummaryModal.message }}
            <div slot="footer">
                <FormButton  @click="() => complaintSummaryModal.visible = false">Ok
                </FormButton>
            </div>
        </Popup>
...
<script>
    ...
    import { generateComplaintRfi, getComplaintRegister, getDepartmentList, exportComplaintRfi, getCompanyStatusList } from './api'
    ...
    export default {
        ...
        created() {
            this.fetchData();
            Event.subscribe('showComplaintPopup', this.showComplaintPopup);
        },
        methods: {
            showComplaintPopup (complaint) {
                this.complaintSummaryModal.message = complaint;
                this.complaintSummaryModal.visible = true;
            },
            generatePdf(){
                const data = {
                    isPdf: true,
            ...
            getData(){
                ...
                getComplaintRegister(data).then(
                    res => {
