...
<script>
    ...
    import { getNotification, getNotificationCount, readNotificationWeb, } from './api';
    ...
    export default {
        ...
        methods:{
            seeNotification(notif){
                this.$router.push({path:`tasks/${notif.TicketReference}`});
                ...
                //         this.$router.push({name:'tasks', query: { TicketReference: notif.TicketReference}});
                //     }
                // )
            },
