    ...
    <!-- <PageSimple> -->
        <FormWrapper :is-loading="isLoading">
            ...
            <div :class="$style.filter">
                ...
                <div :class="$style.filterItem">
                    <FormSelect :width="200" label="Inspection Item" :items="filtering.inspectionItem" item-name="Name" item-value="id" v-model="filtering.inspectionItemSelected" />
                </div>
                <div :class="$style.filterItem">
...
<script>
    ...
    import { getAllInspectionItems, exportINS002Excel, getICSP, getEntityType, getNonCompliantsWithArea } from '../../api'
    ...
    export default {
        ...
        methods: {
            exportExcel() {
                ...
                filters.inspectionitem_id = this.filtering.inspectionItemSelected;
            ...
            handleFilterValues(response) {
                ...
                this.filtering.inspectionItem = response[2].data;
                this.hideLoader();
            },
            sortChange(data) {
