<template>
    <div :class="$style.block">
        ...
        <FormCheckbox :class="$style.pad"  disabled name="Not Applicable" :trueValue="1"  :falseValue="0 || null" v-model="ticket.NAEmployment" ><span ><b> Not Applicable</b></span></FormCheckbox>
        <br>
        ...
        <FormCheckbox :class="$style.pad"  disabled name="Not Applicable" :trueValue="1"  :falseValue="0 || null" v-model="ticket.NADirector" ><span ><b> Not Applicable</b></span></FormCheckbox>
        <br>
        ...
        <FormCheckbox :class="$style.pad"  disabled name="Not Applicable" :trueValue="1"  :falseValue="0 || null" v-model="ticket.NATrust" ><span ><b> Not Applicable</b></span></FormCheckbox>
        <br>
        ...
        <FormCheckbox :class="$style.pad"  disabled name="Not Applicable" :trueValue="1"  :falseValue="0 || null" v-model="ticket.NAPartnership" ><span ><b> Not Applicable</b></span></FormCheckbox>
        <br>
        ...
        <FormCheckbox :class="$style.pad"  disabled name="Not Applicable" :trueValue="1"  :falseValue="0 || null" v-model="ticket.NAPreviousApprovalByFSA" ><span ><b> Not Applicable</b></span></FormCheckbox>
        <br>
        ...
        <FormCheckbox :class="$style.pad"  disabled name="Not Applicable" :trueValue="1"  :falseValue="0 || null" v-model="ticket.NAPreviousApplication" ><span ><b> Not Applicable</b></span></FormCheckbox>
        <br>
