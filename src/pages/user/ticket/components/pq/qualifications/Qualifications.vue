<template>
    <div :class="$style.block">
        ...
        <FormCheckbox :class="$style.pad"  disabled name="Not Applicable" :trueValue="1"  :falseValue="0 || null" v-model="ticket.NAProfQualification" ><span ><b> Not Applicable</b></span></FormCheckbox>
        <br>
        ...
        <FormCheckbox :class="$style.pad"  disabled name="Not Applicable" :trueValue="1"  :falseValue="0 || null" v-model="ticket.NAMemberShip" ><span ><b> Not Applicable</b></span></FormCheckbox>
        <br>
        ...
        <FormCheckbox :class="$style.pad"  disabled name="Not Applicable" :trueValue="1"  :falseValue="0 || null" v-model="ticket.NATraining" ><span ><b> Not Applicable</b></span></FormCheckbox>
        <br>
