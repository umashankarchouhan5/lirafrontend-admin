<template>
    <ValidationObserver ref="observer" v-slot="{ passes }">
        ...
        <PageTitle :title="$route.params.id ? 'Edit International Client User' : 'Create International Client User'" slot="title" />
        <FormRow>
            <!-- <SideLogo></SideLogo> -->
...
<script>
    ...
    import { createIntlClientWebuser, getIntlClientUsersList } from "../api";
    ...
    export default {
        ...
        methods: {
            getUserData() {
                getIntlClientUsersList({client_user_id: parseInt(this.$route.params.id)}).then(
                    res => {
            ...
            formSubmit() {
                ...
                this.form.client_id = parseInt(this.$route.params.client_id);
                createIntlClientWebuser(this.form).then(this.handleResponse)
            },
            ...
            backToList(){
                this.$router.push(`/intlClientUsers/${this.$route.params.client_id}`);
            }
        }
    };
</script>
