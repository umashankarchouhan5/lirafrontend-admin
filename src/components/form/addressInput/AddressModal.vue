<template>
    <Popup :value="isModalVisible" width="700" @close="onClose">
        <ValidationObserver ref="observer" v-if="isModalVisible" v-slot="{ passes }">
            <div :class="$style.wrapper">
                ...
                <FormRow>
                    <div class="col-sm-3">
                        <InputText label="City" v-model="value.city" :rules="{required: isModalVisible}" />
                    </div>
                    <div class="col-sm-3">
                        <InputText label="State" v-model="value.state" />
                    </div>
                    <div class="col-sm-3">
                        <InputText label="Zip Code" v-model="value.zip" />
                    </div>
                    <div class="col-sm-3">
                        <FormSelect
