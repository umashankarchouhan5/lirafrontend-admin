    ...
    <FormRow>
        ...
        <div class="col-sm-3" v-if="value.AnswerYN === 1 || value.FieldType.toLowerCase() === 'yesno'">
            <div :class="$style.selectors" >
                <FormYesNo v-model="value.ValueTextArea" :disabled="readonly || disabled" :rules="{required: value.isMandatory === 1 && disabled === false ? false: true}" ></FormYesNo>

            </div>
        </div>
        <!-- <div class="col-sm-10" v-if="value.FieldType.toLowerCase() === 'checkbox'">
            <p :class="$style.label">
                <slot />
            </p>
        </div> -->
        <div class="col-sm-12" v-if="value.AnswerYN === 1 || value.FieldType.toLowerCase() === 'checkbox'">
            <!-- <div :class="$style.selectors" >
                <FormCheckbox :disabled="readonly || disabled" :rules="{required: value.isMandatory === 1 && disabled === false ? false: true}"  name="NA Box" :trueValue="1"  :falseValue="0" v-model="value.ValueTextArea" ><span >
                <slot />
            </span></FormCheckbox>
            ...
            <div  :class="$style.checkItem">
                <div :class="$style.checkbox">
                    <FormCheckbox :disabled="readonly || disabled"  name="NA Box" :trueValue="1"  :falseValue="0" v-model="value.ValueTextArea" ></FormCheckbox>
                </div>
        ...
        <div v-if="(value.TextBoxonYN !== null && value.TextBoxonYN !== undefined && value.TextBoxonYN === value.ValueTextArea) || (value.TextBoxOnYN !== null && value.TextBoxOnYN !== undefined && value.TextBoxOnYN === value.ValueTextArea) " class="col-sm-12">
            <InputTextArea v-model="value.Notes" label="Notes" :rules="{required: disabled ? false: true}" maxlength="500" :readonly="readonly || disabled" rows="5" />
        </div>
        ...
        <FormRow v-if=" value.FieldType.toLowerCase() === 'table'">
            <div  class="col-sm-12">
                <p v-if="value.Label && value.Label !== null && value.Label !== ''">{{value.Label}}</p>
        ...
        <div v-if=" value.FieldType.toLowerCase() !== 'table' ">
            ...
            <div :class="$style.rowPadding" class="row"  v-if="value.FieldType.toLowerCase() === 'textbox'">
                <div :class="$style.inputsStyle" class="col-sm-6">
                    <div   >
                        <p><b v-if="value.FieldNumber !== null  && value.FieldNumber !== ''">{{value.FieldNumber}}. </b> {{value.Label}} <span v-if="value.isMandatory" :class="$style.required">*</span></p>
                    </div>
                </div>
                <div :class="$style.inputsStyle" class="col-sm-6">
                    <div>
        ...
        <div v-if="value.AllowDocumentUpload === 1 || value.DocumentWhenAnswerYN === value.ValueTextArea" class="col-sm-12">
            <div :class="$style.file" >
                <InputFile label="Select File (pdf)" :readonly="readonly || disabled" :disabled="readonly || disabled"  :rules="{required:disabled ? false: true,docCheck:'pdf'}" />
