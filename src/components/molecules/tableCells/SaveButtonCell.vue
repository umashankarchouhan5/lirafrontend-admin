<template>
    <div :class="$style.save">
        <div :class="$style.flex">
            ...
            <div v-if="(row.isSaved && !readonly) || row.isChange"
                type="success"
            ...
            <div :class="$style.add" v-if="showAddButton && !readonly">
                <AddRemoveButton :is-last="isLast" @add="addDocument" size="small" @remove="removeDocument" :length="this.documents.length" :i="row._index"  />
            </div>
            <br/>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            showAddButton() {
                // return this.canAddDocuments && (!this.row.isSaved || this.isLast);
